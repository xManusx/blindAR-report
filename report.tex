...
\usepackage[backend=biber,style=numeric-verb,urldate=iso,seconds=true,sorting=none,bibencoding=utf8,doi=false,isbn=false,url=false]{biblatex}
...
\title{Innovationlab for Wearable and Ubiquitous Computing -- blindAR}
...
\author{\IEEEauthorblockN{Magnus Berendes\\ blindAR}\\
	\IEEEauthorblockA{Innovation Lab for Wearable and Ubiquitous Computing\\
		Machine Learning and Data Analytics Lab\\
	Friedrich-Alexander-Universit\"at Erlangen-N\"urnberg}
\IEEEauthorblockA{magnus.berendes@fau.de}}
...
%blindAR would like to thank Matthias Maurer and Markus Zrenner for the provided assistance and guidance during the innovation lab. We would also like to thank 
...
%\bibitem{aruco}Detection of ArUco Markers  \url{https://docs.opencv.org/3.1.0/d5/dae/tutorial_aruco_detection.html}. Last visited: 16.09.2013 (2013)  
